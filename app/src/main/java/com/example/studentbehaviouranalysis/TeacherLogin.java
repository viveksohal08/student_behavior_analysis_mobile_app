...
public class TeacherLogin extends AppCompatActivity {
    ...
    Button btnLogin;
    String loginURL = "http://192.168.43.213/sba/login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Create StringRequest for PHP script login.php
                StringRequest stringRequest = new StringRequest(Request.Method.POST, loginURL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.equals("Login unsuccessful.")) {
                            ...
                            Intent i = new Intent(TeacherLogin.this, SubjectDetails.class);
                            i.putExtra("subjectID", response);
                            startActivity(i);
                            finish();
                        }
                    }
                ...
                MySingleton.getInstance(TeacherLogin.this).addToRequestQueue(stringRequest);
            }
        });
    }
